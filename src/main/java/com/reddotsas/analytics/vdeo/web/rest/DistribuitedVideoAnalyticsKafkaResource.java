...
@RestController
@RequestMapping("/api/distribuited-video-analytics-kafka")
public class DistribuitedVideoAnalyticsKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DistribuitedVideoAnalyticsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DistribuitedVideoAnalyticsKafkaResource(KafkaProperties kafkaProperties) {
