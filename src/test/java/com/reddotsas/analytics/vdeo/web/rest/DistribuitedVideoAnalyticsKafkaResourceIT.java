package com.reddotsas.analytics.vdeo.web.rest;
...
import com.reddotsas.analytics.vdeo.config.KafkaProperties;
...
class DistribuitedVideoAnalyticsKafkaResourceIT {
    ...
    void setup() {
        ...
        DistribuitedVideoAnalyticsKafkaResource kafkaResource = new DistribuitedVideoAnalyticsKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/distribuited-video-analytics-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/distribuited-video-analytics-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
